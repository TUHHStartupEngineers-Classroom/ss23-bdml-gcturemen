...
Use your learning from descriptive features and `plot_ggpairs()` to further investigate the features and answer the related questions.
...
__Answer:__ From the figure it can be seen that the employees that are leaving have a lower Monthly income. The answer is c.
...
__Answer:__ Since the curves in the figure are similar, it is difficult to make any comments. The answer is d.
...
__Answer:__ Since the number of staying employees are higher at high stock option levels (1, 2) the answer is b.
...
__Answer:__ From the figure, it can be seen that staying employees have a higher density of 2's and 3's. The answer is b.
...
__Answer:__ From the figure it can be seen that people that leave tend to have less annual trainings. The answer is b.
...
__Answer:__ It is apparent that people that leave tend to have less working years at the company. The answer is b.
...
__Answer:__ Since both curves are similar in the figure it is hard to make a decision. The answer is c.